...
class TestProductModel(unittest.TestCase):
    ...
    def test_create_a_product(self):
        """Test constructor of Inventory class. It should Create a pet and assert that it exists."""
        ...
        product = Inventory(id=5, name="computer", quantity=3, restock_level=1,restock_count=2,
    ...
    def test_insert_item(self):
        ...
        item = Inventory(id = 114, name = "unicorn tear", quantity = 514, restock_level = 8, restock_count = 11, \
        condition = Condition.NEW, first_entry_date=date(2019,1,3), last_restock_date=date(2019,10,16))
        item.create()
        ...
        other_item = Inventory(id = 1, name = "werewolf hair", quantity = 628, restock_level = 8, restock_count = 12, \
            condition = Condition.OPEN_BOX, first_entry_date=date(2012, 4, 3), last_restock_date=date(2017, 9, 21))
        other_item.create()
        product = Inventory.find(114)
        self.assertTrue(product is not None)
        self.assertEqual(product.name, "unicorn tear")
    ...
    def test_update_item(self):
        ...
        #self.setUp()
        product = Inventory(id = 3, name = "reverse bear trap", quantity = 3, restock_level = 10, restock_count = 6, \
            condition = Condition.USED, first_entry_date = date(2004, 10, 31), last_restock_date = date(2010, 10, 31))
        product.create()
    ...
    def test_delete_item(self):
        ...
        prod_1 = Inventory(id = 1, name = "reverse bear trap", quantity = 3, restock_level = 10, restock_count = 6, \
            condition = Condition.USED, first_entry_date = date(2004, 10, 31), last_restock_date = date(2010, 10, 31))
        prod_2 = Inventory(id = 2, name = "venus fly trap", quantity = 1, restock_level = 5, restock_count = 2, \
            condition = Condition.OPEN_BOX, first_entry_date = date(2005, 10, 31), last_restock_date = date(2005, 10, 31))
        prod_3 = Inventory(id = 3, name = "shotgun collar", quantity = 1, restock_level = 1, restock_count = 2, \
            condition = Condition.USED, first_entry_date = date(2006, 10, 31), last_restock_date = date(2017, 10, 31))
        prod_1.create()
        prod_2.create()
        prod_3.create()
    ...
    def test_deserialize(self):
        ...
        data_full = {"id": 1, "name": "full", "quantity": 1, "restock_level": 2, \
        ...
        data_unnamed = {"id": 11, "quantity": 1, "restock_level": 2, \
            "restock_count": 2, "condition": "NEW", "first_entry_date": "2013-11-22", "last_restock_date": "2015-02-03"}
